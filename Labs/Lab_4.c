...
long Vk10()
{
        ...
        long Voltage;       //Result for Voltage
...
void main(void)
{
    ...
    while(1)
    {    
        long k10 = Vk10();      //Result from function Vk10()
        long POT1 = VPOT1();    //Result from function VPOT1()
        
        
        if(k10 > POT1)
        {
            LED_LEFT = 1;       //LED left on
            LED_CENTER = 0;     //LED left off
            LED_RIGHT = 0;      //LED left off
        }
        
        else if(k10 == POT1)
        {
            LED_LEFT = 0;       //LED left off
            LED_CENTER = 1;     //LED left on
            LED_RIGHT = 0;      //LED left off
        }
